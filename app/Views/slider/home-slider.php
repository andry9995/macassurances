            ...
            <ul>
                ...
                <li data-index="rs-1" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300">
                    ...
                    <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" 
                        ...
                        style="z-index: 6;"><img src="/assets/images/slider/slider-1.jpg" alt="" data-ww="['1000px','1000px','800px','500px']" data-hh="['563px','563px','450','281']" width="1200" height="675" data-no-retina> </div>
                    ...
                    <div class="tp-caption tp-resizeme" 
                        ...
                        style="z-index: 7; white-space: normal; font-size: 20px; line-height: 20px; font-weight: 600; color: #ffffff; letter-spacing: 4px;">MAC&nbsp;ASSURANCES</div>
                    ...
                    <div class="tp-caption   tp-resizeme" 
                        ...
                        data-paddingleft="[20,20,20,20]"
                        style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px; font-family: serif;">Le Contrat de de confiance. </div>
                </li>
                <!-- SLIDE  -->
                <!-- SLIDE  -->
                <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300">
                    <!-- MAIN IMAGE -->
                    <img src="#" class="rev-slidebg" data-bgcolor='linear-gradient(90deg, #969593 0%, #0092e0 100%)' alt="transparent image">
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption   tp-resizeme" 
                        ...
                        data-paddingbottom="[30,30,30,30]"
                        data-paddingleft="[20,20,20,20]"
                        style="z-index: 8; min-width: 650px; max-width: 650px; white-space: normal; font-size: 70px; line-height: 70px; font-weight: 400; color: #ffffff; letter-spacing: -2px; font-family: serif;">Le Contrat de confiance. </div>
                </li>
                <!-- SLIDE  -->
